...
for day in range(3*365):  # For each day in the past 3 years
    for i in range(20):  # Generate 100 records for each day
        ...
        time_entered = datetime.now() - timedelta(days=day, hours=random.randint(0, 23), minutes=random.randint(0, 59), seconds=random.randint(0, 59))
        ...
        time_exited = time_entered + timedelta(minutes=random.randint(1, 60))  # Add a random number of minutes to the time entered
